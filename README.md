...
Alerta lumínica: Parpadeo de dos herzios, no vermell saturat, pel manillar. 
Alerta sonora i vivbració:


Ignormos la velocidad, lo podemos implementar con OpenCV para identificar distancias. 
